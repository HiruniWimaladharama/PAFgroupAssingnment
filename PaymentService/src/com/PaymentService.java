...
public class PaymentService {
	...
	public String insertPayments(@FormParam("paymentCode") String paymentCode,
			@FormParam("paymentType") String paymentType, @FormParam("paymentAmount") String paymentAmount,
