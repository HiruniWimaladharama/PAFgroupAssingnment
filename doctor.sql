...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 18, 2020 at 06:23 PM
...
(4, 'D011', 'dr.oshini malsha', 'dr.oshini malsha', 'spe'),
...
(10, 'D008', '986575763V', 'dr.sajeentha ', 'radiologist');
...
--
ALTER TABLE `doctors`
  MODIFY `doctorID` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
